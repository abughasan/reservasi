		...
		<div class="panel-heading">
		  <h4 class="panel-title">			
			  ...
			  <select id="tahunkalender" class="hidden-print">
				...
				<option value="2015" <?php (($tahun=="2015") ? print 'selected' : '' )?>>2015</option>								  </select> 
...
$.ajax({
	url:'<?=base_url()?>fin_kas/view/'+bulan+'/'+tahun+'/'+bulantext, cache: false,
	beforeSend: function(){
		$("#kas_content").html("<img src=<?=base_url()."assets/img/ajax-loader-small.gif"?> />")
	},
	success: function(msg){
		$("#kas_content").html(msg);
